        ...
        for v in azure_json["values"]:
            for address_prefix in v["properties"]["addressPrefixes"]:
                ...
                if ip_address(target_ip) in subnet:
                    results.append({"service": ("N/A", v["properties"]["systemService"])[v["properties"]["systemService"]], "region": ("N/A", v["properties"]["region"])[v["properties"]["region"]], "regionId": v["properties"]["regionId"], "address_prefix": address_prefix})
